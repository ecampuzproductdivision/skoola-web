...
<div class="custom-container">
  ...
  <div class="d-flex align-items-center gap-3 mb-6">
    ...
    <h1 class="h2 mb-1">Create New Permission</h1>
  </div>
      ...
      <form action="{{ route('permissions.store') }}" method="POST">
        ...
        <div class="row g-4 mb-4">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="e.g. Create User" value="{{ old('name') }}" required>
            @error('name')
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" placeholder="e.g. kejarkarir.users.create" value="{{ old('code') }}" required>
        ...
        <div class="mb-5">
          ...
          <textarea name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Provide a short description of what this permission allows...">{{ old('description') }}</textarea>
          @error('description')
            <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="d-flex justify-content-end gap-3 pt-3 border-top">
          ...
          <button type="submit" class="btn btn-danger px-4 py-2" style="background-color: #ef5350; border-color: #ef5350;">Create Permission</button>
        </div>

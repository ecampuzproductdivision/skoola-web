...
<div class="custom-container">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-6">
    <div>
      ...
      <p class="text-gray-600 mb-0">Manage system users and assign their access level / role.</p>
    </div>
    <div class="d-flex gap-2">
      @can('kejarkarir.users.create')
  ...
  <div class="card shadow-sm">
    ...
    <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 bg-transparent py-4">
      <form action="{{ route('users.index') }}" method="GET" class="d-flex align-items-center gap-2 mb-0">
        ...
        <select name="role_id" class="form-select" style="max-width: 180px;">
        ...
        <a href="{{ route('users.index') }}" class="btn btn-white btn-icon d-inline-flex align-items-center justify-content-center" style="width: 38px; height: 38px;">
    ...
    <div class="d-flex align-items-center gap-2 px-4 py-3 text-gray-600">
      ...
      <span class="fw-semibold">Menampilkan {{ $users->count() }} dari {{ App\Models\User::count() }} data</span>
    </div>
    ...
    <div class="table-responsive border-top">
      <table class="table table-hover table-centered text-nowrap mb-0">
        <thead class="table-light">
          <tr>
            <x-sortable-th label="USER" column="name" class="py-4 ps-4" />
            <x-sortable-th label="EMAIL" column="email" class="py-4" />
            <x-sortable-th label="ROLE" column="role" class="py-4" />
            <x-sortable-th label="CREATED" column="created_at" class="py-4" />

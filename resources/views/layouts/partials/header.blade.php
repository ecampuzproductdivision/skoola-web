...
<div class="navbar-glass navbar navbar-expand-lg px-0 px-lg-4">
  <div class="container-fluid px-lg-0">
    ...
    <ul class="list-unstyled d-flex align-items-center mb-0 gap-2">
      ...
      <li>
        <div class="dropdown">
          <button class="btn btn-ghost btn-icon d-flex align-items-center" type="button" aria-expanded="false" data-bs-toggle="dropdown" aria-label="Toggle theme (auto)">
      ...
      <!-- Bell icon -->
      <li>
        <a class="position-relative btn-icon btn-ghost btn" data-bs-toggle="offcanvas" href="#offcanvasNotification" role="button" aria-controls="offcanvasNotification">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
      ...
      <li class="ms-3 dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-0">
          <div>
            <div class="d-flex gap-3 align-items-center border-solid border-bottom px-4 py-4">
              ...
              <div>
                ...
                @if (Auth::user()->role)
                  <span class="badge bg-primary-subtle text-primary border border-primary-subtle rounded-pill px-3 py-1 mt-1">{{ Auth::user()->role->display_name }}</span>
                @endif
              </div>
            </div>
              ...
              <a href="{{ route('profile.show') }}" class="dropdown-item d-flex align-items-center gap-2">
                <span
                  ...
                  >
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path
                      d="M10.325 4.317c.426 -1.756 2.924 -1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543 -.94 3.31 .826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756 .426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543 -.826 3.31 -2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756 -2.924 1.756 -3.35 0a1.724 1.724 0 0 0 1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z"
                    />
            ...
            <div class="border-solid border-top mb-4 pt-4 px-6">
              <a href="#!" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="text-secondary d-flex align-items-center gap-2">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNotification" aria-labelledby="offcanvasNotificationLabel">
    ...
    <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab" tabindex="0">
      <div data-simplebar="" style="height: 800px">
        <div class="list-group list-group-flush">
          <a href="#" class="list-group-item list-group-item-action p-5 border-solid border-bottom">
  ...
  <div class="px-5 py-3 text-center bg-white position-absolute bottom-0 border-top border-solid w-100 text-center">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body" data-simplebar="" style="height: 400px">
        <div class="mb-4">
          <div class="d-flex flex-column border-bottom border-solid py-4">
            <div class="mb-2">
              <span class="fw-semibold text-secondary small">Dashboard</span>
            </div>
            <div>
              <ul class="list-unstyled lh-lg mb-0">
                <li><a href="./dashboard/analytics.html" class="text-inherit">Analytics</a></li>
                <li><a href="./dashboard/project.html" class="text-inherit">Project</a></li>
                <li><a href="./dashboard/ecommerce.html" class="text-inherit">Ecommerce</a></li>
                <li><a href="./dashboard/crm.html" class="text-inherit">CRM</a></li>
                <li><a href="./dashboard/finance.html" class="text-inherit">Finance</a></li>
                <li><a href="./dashboard/blog.html" class="text-inherit">Blog</a></li>
              </ul>
            </div>
          </div>
          <div class="d-flex flex-column border-bottom border-solid py-4">
            ...
            <div>
              <ul class="list-unstyled lh-lg mb-0">
                <li><a href="./apps/calendar.html" class="text-inherit"> Calendar</a></li>
                <li><a href="./apps/chat-app.html" class="text-inherit"> Chat</a></li>
                <li><a href="./apps/email/mail.html" class="text-inherit">Email</a></li>
                <li><a href="./apps/e-commerce/ecommerce-products.html" class="text-inherit">Ecommerce</a></li>
                <li><a href="./apps/kanban.html" class="text-inherit"> Kanban</a></li>
                <li><a href="./apps/project/project-grid.html" class="text-inherit">Project</a></li>
                <li><a href="./dashboard/file.html" class="text-inherit"> File Manager</a></li>
                <li><a href="./apps/crm/crm-contacts.html" class="text-inherit"> CRM</a></li>
                <li><a href="./apps/invoice/invoice-list.html" class="text-inherit"> Invoice</a></li>
                <li><a href="./apps/profile/profile-overview.html" class="text-inherit"> Profile</a></li>
                <li><a href="./apps/blog/blog-list.html" class="text-inherit"> Blog</a></li>
              </ul>
            </div>
          </div>
          <div class="d-flex flex-column border-bottom border-solid py-4">
